...
<title>view eds</title>
</head>
<body>
	<div class="row">
		<div class="col-md-5">
			<div id="viewpicture" class="img-container" style="height: auto; width: 100%">
				<img id="imgview">
			</div>
		</div>
		<div class="col-md-7">
			<textarea class="form-control" rows="18" id="finaltext" wrap="off"  spellcheck="false" readonly="readonly" style="background-color: #fff;"></textarea>
		</div>		
	</div>
